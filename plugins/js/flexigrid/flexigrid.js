...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 title: false,
			 pagestat: 'Menampilkan {from} - {to} dari {total} data',
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2' style='padding-top:15px;float:left;position:relative;width:700px'>Filter Data : <input type='text' size='30' name='q' class='input' /> <select name='qtype' class='input'>"+sopt+"</select> <input type='button' name='bcari' value='Cari' class='btn'/> <input type='button' value='Clear'  class='btn'/></div>");

				$('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){if(e.keyCode==13) g.doSearch()});
				$('input[name=bcari]',g.sDiv).click(function(){g.doSearch()});
