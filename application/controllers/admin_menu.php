...
class Admin_menu extends CI_Controller {
	...
	function index()
	{
		$this->authentication->verify('admin_menu','show');
	...
	function add()
	{
		$this->authentication->verify('admin_menu','add');
	...
	function dodel(){
		$this->authentication->verify('admin_menu','del');
		$data = $this->uri->ruri_to_assoc();
	...
	function doorder()
	{
		$this->authentication->verify('admin_menu','edit');
