...
class Admin_content_model extends CI_Model {
    ...
    function news_get_data($options,$start,$limit)
    {
		$options['lang'] = $this->lang;
    ...
    function gallery_get_data($options,$start,$limit)
    {
		$options['lang'] = $this->lang;
		$this->db->where($options);
        $query = $this->db->get($this->tabel_content,$limit,$start);
    ...
    function event_get_data($options,$start,$limit)
    {
		$options['lang'] = $this->lang;
		$this->db->order_by('dtime','DESC');
		$this->db->where($options);
   ...
   function event_add_entry($file_id)
    ...
    function video_get_data($options,$start,$limit)
    {
		$options['lang'] = $this->lang;
		$this->db->order_by('dtime','DESC');
		$this->db->where($options);
    ...
    function download_get_data($options,$start,$limit)
    {
		$options['lang'] = $this->lang;
		$this->db->where($options);
        $query = $this->db->get($this->tabel_content,$limit,$start);
