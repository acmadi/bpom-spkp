<script>
	$(function(){
       ...
       $("#absensi_-_uang_makan").addClass("active");
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_absen_makan/json",
		cache: false,
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_absen_makan/add" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_absen_makan/html",
		...
		$('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_absen_makan/excel",
				success: function(response){
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_makan/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_makan/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
...
<div id="popup" style="display:none"><div id="popup_title">Absensi Uang Makan</div><div id="popup_content">{popup}</div></div>
<div>
