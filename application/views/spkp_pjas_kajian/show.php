<script>
	$(function(){
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_pjas_kajian/json_judul",
		cache: false,
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_pjas_kajian/add" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_pjas_kajian/html",
		...
		$('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_pjas_kajian/excel",
				success: function(response){
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_pjas_kajian/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_pjas_kajian/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
...
<div id="popup" style="display:none"><div id="popup_title">Kajian PJAS</div><div id="popup_content">{popup}</div></div>
<div>
