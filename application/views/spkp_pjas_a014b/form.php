<script type="text/javascript">
    ...
    function save_form(){
        ...
        $.ajax({
           type: "POST",
           url: "<?php echo base_url(); ?>spkp_pjas_a014b/doedit_form/{id}",
           ...
           success: function(response){
                if(response=="1"){
                   ...
                   $.ajax({
                     type: "POST",
                     url: "<?php echo base_url(); ?>spkp_pjas_a014b/load_form/{id}",
                     success: function(response){
                        $("#divForm").show();
    ...
    function back(){
        window.location.href = "<?php echo base_url(); ?>spkp_pjas_a014b";
    }
    
    function export_word(){
        $.ajax({
           type: "POST",
           url: "<?php echo base_url(); ?>spkp_pjas_a014b/export/{id}",
           success: function(response){
    ...
    function import_dialog(){
		...
		$.get("<?php echo base_url();?>spkp_pjas_a014b/load_form_import/{id}" , function(response) {
...
<div id="popup" style="display:none"><div id="popup_title">Import Form A014b</div><div id="popup_content">{popup}</div></div>
            ...
            <tr>
                <td colspan="2">
                    <table border='0' width='100%' cellpadding='3' cellspacing='2' style="font-size: 12px;color: black">
                        <tr>
                            <td width='9%'>Balai Besar / Balai POM</td>
