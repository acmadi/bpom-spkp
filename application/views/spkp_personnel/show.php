<script>
	$(function(){
       ...
       var source = {
		...
		url: "<?php echo base_url(); ?>index.php/spkp_personnel/json_user",
		cache: false,
        ...
        $("#jqxgrid").jqxGrid({		
			...
			columns: [
                ...
                { text: 'NIP', datafield: 'nip', filtertype: 'textbox',  width: 165, cellsrenderer: cellsrenderer},
				{ text: 'Nama', datafield: 'nama', filtertype: 'textbox', width: 200 },
                { text: 'Gelar', datafield: 'gelar', filtertype: 'textbox', width: 150 },
                { text: 'Jenis Kelamin', datafield: 'gendre', filtertype: 'list', width: 100, cellsalign: 'center' },
                { text: 'Tanggal Lahir', datafield: 'birthdate', columntype: 'date', filtertype: 'date', cellsformat: 'yyyy-MM-dd', width: 100, cellsalign: 'center' },
                { text: 'Tempat Lahir', datafield: 'birthplace', filtertype: 'textbox', width: 150 },
                { text: 'Telp', datafield: 'mobile', filtertype: 'textbox', width: 110 }
            ]
		});
        ...
        $('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personnel/html",
        ...
        $('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_personnel/excel",
				success: function(response){
	...
	function edit(id){
		window.location.href = "<?php echo base_url(); ?>spkp_personnel/edit/"+id;
	}
