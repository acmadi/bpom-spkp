<script type="text/javascript">
    $(document).ready(function(){
       ...
       var source = {
		...
		url: "<?php echo base_url(); ?>index.php/spkp_personnel/json_pangkat/{id}",
		cache: false,
        ...
        $('#btnTambahPangkat').click(function(){
			...
			$.get("<?php echo base_url();?>index.php/spkp_personnel/add_pangkat" , function(response) {
        ...
        $('#printbuttonPangkat').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personnel/html_pangkat/{id}",
        ...
        $('#excelbuttonPangkat').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_personnel/excel_pangkat/{id}",
				success: function(response){
    ...
    function edit_pangkat(id,id_golruang){
        ...
        $("#popup_pangkat").jqxWindow('open');
		$.get("<?php echo base_url();?>index.php/spkp_personnel/edit_pangkat/"+id+"/"+id_golruang , function(response) {
			$("#popup_pangkat_content").html("<div>"+response+"</div>");
		});
	}
	...
	function save_edit_pangkat_dialog(content){
	   	$.ajax({ 
			type: "POST",
			url: "<?php echo base_url()?>index.php/spkp_personnel/doedit_pangkat",
			data: content,
			success: function(response){
				 if(response=="1"){
    ...
    function save_add_pangkat_dialog(content){
		$.ajax({ 
			type: "POST",
			url: "<?php echo base_url()?>index.php/spkp_personnel/doadd_pangkat/{id}",
			data: content,
			success: function(response){
				 if(response=="1"){
					 close_pangkat_dialog();
    ...
    function dodel_pangkat(urut,id,id_golruang){
		if(confirm("Anda yakin akan menghapus data ("+urut+") ini?")){
			$.ajax({ 
				type: "POST",
				url: "<?php echo base_url()?>index.php/spkp_personnel/dodel_pangkat/"+id+"/"+id_golruang,
				success: function(response){
					 if(response=="1"){
						 $('#clearfilteringbuttonPangkat').click();
						 $.notific8('Notification', {
