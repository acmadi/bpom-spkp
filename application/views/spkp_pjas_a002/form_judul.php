<script type="text/javascript">
    $(document).ready(function(){
		...
		$("textarea").jqxInput({ theme: theme, width: '320px', height:'100px' });
    ...
    function save_add_judul_dialog(content){
		$.ajax({ 
			type: "POST",
    ...
    <div id="divForm" style="padding:8px">
        <form method="post" id="frmDatajudul">
            <div style="padding: 5px;text-align: center;">
                <button type="button" onclick="save_{action}_judul_dialog($('#frmDatajudul').serialize());">Simpan</button>
