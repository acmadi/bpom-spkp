<script>
	$(function(){
       ...
       $("#absensi_-_bulanan").addClass("active");
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_absen_bulanan/json",
		cache: false,
		...
		{		
			...
			columns: [
				...
				{ text: 'Tahun', datafield: 'tahun', columntype: 'dropdownlist', filtertype: 'list', width: '5%' },
				{ text: 'Bulan', datafield: 'bulan', columntype: 'dropdownlist', filtertype: 'list', width: '5%' },
				{ text: 'Subdit', datafield: 'ket', columntype: 'dropdownlist', filtertype: 'list', width: '30%' },
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_absen_bulanan/add" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_absen_bulanan/html",
		...
		$('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_absen_bulanan/excel",
				success: function(response){
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_bulanan/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_bulanan/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
...
<div id="popup" style="display:none"><div id="popup_title">Absensi Bulanan</div><div id="popup_content">{popup}</div></div>
<div>
