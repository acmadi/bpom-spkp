<script type="text/javascript">
    ...
    function save_form(){
        ...
        $.ajax({
           type: "POST",
           url: "<?php echo base_url(); ?>spkp_pjas_a019/doedit_form/{id}",
           ...
           success: function(response){
                if(response=="1"){
                   ...
                   $.ajax({
                     type: "POST",
                     url: "<?php echo base_url(); ?>spkp_pjas_a019/load_form/{id}",
                     success: function(response){
                        $("#divForm").show();
    ...
    function back(){
        window.location.href = "<?php echo base_url(); ?>spkp_pjas_a019";
    }
    
    function export_word(){
        $.ajax({
           type: "POST",
           url: "<?php echo base_url(); ?>spkp_pjas_a019/export/{id}",
           success: function(response){
    ...
    function import_dialog(){
		...
		$.get("<?php echo base_url();?>spkp_pjas_a019/load_form_import/{id}" , function(response) {
...
<div id="popup" style="display:none"><div id="popup_title">Import Form A019</div><div id="popup_content">{popup}</div></div>
                        ...
                        <tr>
                            ...
                            <td width='50%'>
                                <select size="1" name="id_balai" style="width: 230px;">
                                    <?php
                                    $data_balai = $this->spkp_pjas_a019_model->get_all_balai();
