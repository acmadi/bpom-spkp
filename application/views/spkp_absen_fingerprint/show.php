<script>
	$(function(){
       ...
       $("#absensi_-_fingerprint").addClass("active");
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_absen_fingerprint/json",
		cache: false,
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_absen_fingerprint/add" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_absen_fingerprint/html",
		...
		$('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_absen_fingerprint/excel",
				success: function(response){
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_fingerprint/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_absen_fingerprint/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
...
<div id="popup" style="display:none"><div id="popup_title">Absensi Fingerprint</div><div id="popup_content">{popup}</div></div>
<div>
