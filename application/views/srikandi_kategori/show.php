...
<div>
	<div style="width:100%;background-color:#DDDDDD;-moz-border-radius:5px;border-radius:5px;padding:2px;border:3px solid #ebebeb;">
        ...
        <?php } ?>
        <br><br>
        <span style='float: left; position:relative; margin-top: 5px; margin-right: 4px;'>Pilih Subdit: </span>
        <div style='float: left;position:relative;width:500px'><select onchange="myFunction()" class='jqx-input jqx-widget-content jqx-rc-all' id='filter_subdit' name='filter_subdit' style='height: 23px; float: left; width: 450px;' >{option_subdit}</select></div>
        {menu_tree}
