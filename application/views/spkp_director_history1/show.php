        ...
        $("#jqxgrid").jqxGrid({		
			...
			columns: [
                ...
                { text: 'Poto', align: 'center', datafield: 'image', width: 80, cellsrenderer: function (row, column, value) {
                          return '<img width="80" src="http://theredzonez-rig/bpom/2013/spkp/media/images/smily-user-icon.jpg"/>';
                      }
				},
                ...
                { text: 'Gelar', datafield: 'gelar', filtertype: 'textbox', width: 100, align: 'center', cellsalign: 'center' },
                { text: 'Pangkat', filtertype: 'textbox', width: 100, align: 'center', cellsalign: 'center' },
                { text: 'Masa Jabatan', filtertype: 'textbox', width: 100, align: 'center', cellsalign: 'center' },
                { text: 'Kelamin', datafield: 'gendre', filtertype: 'list', width: 90, align: 'center', cellsalign: 'center' },
                { text: 'Agama',filtertype: 'textbox', width: 120, align: 'center', cellsalign: 'center' },
