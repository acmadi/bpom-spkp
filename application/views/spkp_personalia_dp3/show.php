<script>
	$(function(){
       ...
       var source = {
		...
		url: "<?php echo base_url(); ?>spkp_personalia_dp3/json_user",
		cache: false,
        ...
        $('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personalia_dp3/html",
	...
	function edit(id){
		window.location.href = "<?php echo base_url(); ?>spkp_personalia_dp3/detail/"+id;
	}
