<script>
	$(function(){
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_personalia_sasaran/json_sasaran/{id}",
		cache: false,
		...
		$('#backbutton').click(function () {
			window.location.href="<?php echo base_url()?>spkp_personalia_sasaran/";
		});
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_personalia_sasaran/add/{uid}" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personalia_sasaran/html/{id}",
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_personalia_sasaran/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_personalia_sasaran/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
