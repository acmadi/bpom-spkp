<script>
	$(function(){
       ...
       var source = {
		...
		url: "<?php echo base_url(); ?>spkp_personalia_sasaran/json_user",
		cache: false,
        ...
        $('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personalia_sasaran/html",
	...
	function edit(id){
		window.location.href = "<?php echo base_url(); ?>spkp_personalia_sasaran/detail/"+id;
	}
