<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#btnSimpan,#btnUlang").jqxInput({ theme: 'fresh', height: '29px', width: '54px', disabled:true});
        $("#btnBatal").jqxInput({ theme: 'fresh', height: '29px', width: '54px', disabled:false});
        $("input,select").jqxInput({ theme: theme, height: '24px', disabled:true});
		$("textarea").jqxInput({ theme: theme, disabled:true});
        $("#birthdate").jqxDateTimeInput({ width: '110px', height: '25px', formatString: 'yyyy-MM-dd', theme: theme, value: '{birthdate}', disabled:true});
        $("#badan_tinggi").jqxNumberInput({ width: '50px', height: '20px', min: 100, theme: 'fresh', spinButtons: true, digits: 3, decimalDigits: 0, value: '{badan_tinggi}', disabled:true });
        $("#badan_berat").jqxNumberInput({ width: '50px', height: '20px', min: 30, theme: 'fresh', spinButtons: true, digits: 3, decimalDigits: 0, value: '{badan_berat}', disabled:true });
...
<div id="divFormProfile" style="padding:8px">
        ...
        <div style="background: #F4F4F4;padding: 5px;text-align: right;">
            ...
            <button type="button" onclick="save_profile();" id="btnSimpan">Simpan</button>
        	<button type="reset" id="btnUlang">Ulang</button>
        ...
        <tr>
            ...
            <td width='50%'>
                <input type="text" size="15" maxlength="15" name="nip" id="nip" value="{nip}" style="margin: 0;height: 30px;"/>
            </td>
        </tr>
        <tr>
