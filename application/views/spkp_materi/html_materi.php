...
<div id="datacetamateri" style="padding:10px;padding-top:50px;text-align:center;border: 1px solid rgb(204,209,205);background: rgb(244,244,244);min-height:600px">
	<table id="tabeldatamateri" cellpadding="2" cellspacing="2" width="100%" border='0'>
		<thead>
