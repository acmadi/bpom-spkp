<script type="text/javascript">
	...
	function export_dialog() {
		...
		var filter = $("#jqxgridpembinaan,#jqxgridpengawalan").jqxGrid('getfilterinformation');
		k=0;
		...
		$.ajax({ 
			...
			url: "<?php echo base_url();?>spkp_pjas_f2/export/{id}",
    ...
    function edit_dialog(){
        ...
        $.ajax({
           type: "POST",
           url: "<?php echo base_url(); ?>spkp_pjas_f2/doedit/{id}",
    ...
    function back(){
        window.location.href = "<?php echo base_url(); ?>spkp_pjas_f2";
    }
    ...
    function import_dialog(){
		...
		$.get("<?php echo base_url();?>spkp_pjas_f2/load_form_import/{id}" , function(response) {
...
<div id="popup" style="display:none"><div id="popup_title">Import Form F2</div><div id="popup_content">{popup}</div></div>
<div style="display: none;" id="divload"></div>
<div id="divForm" style="height: 350; padding:8px;border-bottom:0">
