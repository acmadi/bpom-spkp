	...
	$(function(){
		...
		$('#flexmaster').flexigrid({
			...
			colModel : [
				...
				{display: 'Jabatan', name : 'id_jabatan', width : 490, sortable : true, align: 'left'},
			...
			searchitems : [
				{display: 'ID', name : 'a.id', isdefault: true},
				{display: 'Jabatan', name : 'b.nama_jabatan'},
				{display: 'NIP', name : 'a.nip'},
				{display: 'Nama', name : 'a.nama'},
				{display: 'Status', name : 'a.status'},
			],
			usepager: true,
			rp: 15,
