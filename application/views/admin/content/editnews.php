<script type="text/javascript">
	$(function() {
		...
		new AjaxUpload($('#linkimages'), {
			action: '<?php echo base_url()?>index.php/admin_content/douploadimages/{file_id}/news',
			name: 'uploadfile',
			...
			onComplete: function(file, response){
				...
				$.ajax({ url: "<?php echo base_url()?>index.php/admin_content/filelist/media__images__news__{file_id}", context: document.body, success: function(result){
		...
		new AjaxUpload($('#thumb_linkimages'), {
			action: '<?php echo base_url()?>index.php/admin_content/douploadimages/{file_id}/news/100',
			name: 'uploadfile',
			onSubmit: function(file, ext){
			...
			onComplete: function(file, response){
				...
				if(stat==="success"){
					$('#thumb_linkimages').attr("src", "<?php echo base_url()?>media/images/news/{file_id}/"+filename);
					$('#links').val("<?php echo base_url()?>media/images/news/{file_id}/"+filename);
...
<?php } ?>
<div class="clear">&nbsp;</div>
<form action="<?php echo base_url()?>index.php/admin_content/doeditnews/file_id/{file_id}/id/{id}" method="POST" name="frmFiles">
	<button type="submit" class=btn>Simpan</button>
	<button type="reset" class=btn>Ulang</button>
	<button type="button" class=btn onclick="document.location.href='<?php echo base_url()?>index.php/admin_content/editnews/file_id/{file_id}';">Kembali</button>
	<br />
	<br />
