<script type="text/javascript">
    $(document).ready(function(){
        ...
        <?php }else{ ?>
            $.get("<?php echo base_url()?>index.php/spkp_director_history/select_jabatan/{id_subdit}/{id_jabatan}", function(response) {
        ...
        $("#id_subdit").change(function(){
           $.get("<?php echo base_url()?>index.php/spkp_director_history/select_jabatan/"+ $(this).val(), function(response) {
				var data = eval(response);
