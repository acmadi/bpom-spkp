<script type="text/javascript">
    $(document).ready(function(){
        $("input[type='button']").jqxInput({ theme: 'fresh', height: '20px', width: '100px' });
...
<div id="divFormProfile" style="padding:8px">
        ...
        <div style="position:relative;float:right;right:200px;border:15px solid #EFEFEF;top:50px">
    		...
    		if($image==""){
    			...
    			?>
    			<img src="<?php echo base_url(); ?>media/images/director/{image}" width="200" height="200" style="border: 1px solid #404040;cursor: pointer;" onclick="upload_image()"/>
    			<?php
    		}
    		?>
	    </div>
