<script>
	$(function(){
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_personalia_kerjasama_int/json_upload/{departemen}",
		cache: false,
		...
		{		
            ...
            rendertoolbar: function (toolbar) {
				...
				departemeninput.change(function(){
					window.location.href="<?php echo base_url(); ?>spkp_personalia_kerjasama_int/index/"+departemeninput.val();
                });
			},
            columns: [
	   ...
	   $('#btn_tambah_upload').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_personalia_kerjasama_int/add_upload/{departemen}" , function(response) {
		...
		$('#printbutton_upload').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_personalia_kerjasama_int/html_upload/{departemen}",
		...
		$('#excelbutton_upload').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_personalia_kerjasama_int/excel_upload/{departemen}",
				success: function(response){
	...
	function edit_upload(id){
		...
		$("#popup_upload").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_personalia_kerjasama_int/edit_upload/{departemen}/"+id , function(response) {
			$("#popup_content_upload").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup_upload").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_personalia_kerjasama_int/download/"+id , function(response) {
			$("#popup_content_upload").html("<div>"+response+"</div>");
		});
	}
