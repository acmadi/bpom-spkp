<script type="text/javascript">
    $(document).ready(function(){
       ...
       if('{status_kirim}'=='0'){
           ...
           $("input[name='alasan_tambahan']").jqxInput({ theme: 'fresh', height: '23px', width: '380px' }); 
...
<div id="popup" style="display:none"><div id="popup_title">Form Dokumen Cuti/Izin</div><div id="popup_content"></div></div>
        <form method="POST" id="frmDataIzin">
           ...
           <table width='65%' cellpadding='4' cellspacing='2' border='0' align='center' style="font-size: 13px;color: black">
                <tr>
                    <td colspan="3">Formulir Cuti Karena Alasan Penting</td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        if($status_kirim=="1"){
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permintaan cuti alasan penting selama {prm_jml} hari
                                terhitung mulai tanggal {prm_stat_tgl}, karena {prm_alasan_tambahan}
                            ...
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permintaan cuti alasan penting selama <input type="text" size="8" value="{prm_jml}" name="jml" style="border: 0px;border-bottom: dotted;text-align: center;"/>
                                hari terhitung mulai tanggal <div id="stat_tgl"></div>, karena
                                <input type="text" size="80" value="{prm_alasan_tambahan}" name="alasan_tambahan" style="border: 0px;border-bottom: dotted"/>
