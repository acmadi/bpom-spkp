                ...
                <tr>
                    <td colspan="3">
                        ...
                        if($status_kirim=="1"){
                            ...
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permintaan cuti diluar tanggungan negara selama <input type="text" size="8" value="{prm_jml}" name="jml" style="border: 0px;border-bottom: dotted;text-align: center;"/>
                                ...
                                terhitung mulai tanggal <div id="stat_tgl"></div>
                                dengan alasan sebagai berikut <input type="text" size="80" value="{prm_alasan_tambahan}" name="alasan_tambahan" style="border: 0px;border-bottom: dotted"/>
