<script type="text/javascript">
    $(document).ready(function(){
       ...
       if('{status_kirim}'=='0'){
           $("input[name='stat_tm_jam']").jqxInput({ theme: 'fresh', height: '23px', width: '50px' }); 
           ...
           <table width='65%' cellpadding='4' cellspacing='2' border='0' align='center' style="font-size: 13px;color: black">
                <tr>
                    <td colspan="3" style="font-weight: bold;font-size: 16px;text-align: center;">
                        SURAT PERMOHONAN IZIN</br> 
                        TERLAMBAT MASUK (TM) ATAU PULANG SEBELUM WAKTUNYA (PSW)
                    </td>   
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        if($status_kirim=="1"){
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permohonan izin <?php if($prm_stat_tm=="masuk") echo "terlambat ".$prm_stat_tm; else echo $prm_stat_tm." sebelum waktunya"; ?>*)
                                pada {prm_stat_tgl} pukul {prm_stat_tm_jam} WIB, dengan alasan :
                                </br>
                                <table style="font-size: 13px;color: black">
                                    ...
                                    <tr>
                                        <td>1.</td>
                                        <td>Kondisi force majeure berupa</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><p align='justify'>{prm_stat_tm_alasan_kondisi}</p></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>2.</td>
                                        <td>Keperluan pribadi yang mendesak berupa </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td><p align='justify'>{prm_stat_tm_alasan_perlu}</p></td>
                                    </tr>
                                </table>
                            </p>
                            <?php
                            ...
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permohonan izin terlambat 
                                <select size='1' name='stat_tm' style='width: 80px;'>
                                  <option value='masuk'  <?php if(strtolower($prm_stat_tm)=="masuk") echo "Selected"; ?>>Masuk</option>
                                  <option value='pulang' <?php if(strtolower($prm_stat_tm)=="pulang") echo "Selected"; ?>>Pulang</option>
                               </select>*)
                                pada <div id="stat_tgl"></div> pukul <input type="text" size="10" value="{prm_stat_tm_jam}" name="stat_tm_jam" style="border: 0px;border-bottom: dotted;text-align: center;"/> WIB, dengan alasan :
                                </br>
                                <table style="font-size: 13px;color: black">
                                     <tr>
                                        <td colspan="2">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>
                                            <textarea cols="80" rows="4" wrap="virtual" name="stat_tm_alasan_kondisi" style="width: 420px;">{prm_stat_tm_alasan_kondisi}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td>
                                            <textarea cols="80" rows="4" wrap="virtual" name="stat_tm_alasan_perlu" style="width: 420px;">{prm_stat_tm_alasan_perlu}</textarea>
                                        </td>
                                    </tr>
                                </table>
                            </p>
                ...
                <tr>
                    <td colspan="3" style="text-align: right;">{prm_tgl}</td>
                </tr>
                <tr>
                    <td colspan="3" style="text-align: center"><span style="margin-left: 520px;">Pemohon</span></td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
