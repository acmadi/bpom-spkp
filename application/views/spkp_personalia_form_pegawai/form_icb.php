...
<div id="popup" style="display:none"><div id="popup_title">Form Dokumen Cuti/Izin</div><div id="popup_content"></div></div>
        <form method="POST" id="frmDataIzin">
           ...
           <table width='65%' cellpadding='4' cellspacing='2' border='0' align='center' style="font-size: 13px;color: black">
                <tr>
                    <td colspan="3">Formulir Cuti Besar</td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        if($status_kirim=="1"){
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permintaan cuti besar selama {prm_jml} {prm_hitungan},
                                karena saya telah bekerja secara terus menerus selama {prm_stat_thnkerja} tahun.
                            ...
                            <p align='justify'>
                                ...
                                Dengan ini mengajukan permintaan cuti besar selama <input type="text" size="8" value="{prm_jml}" name="jml" style="border: 0px;border-bottom: dotted;text-align: center;"/>
                                ...
                                karena saya telah bekerja secara terus menerus selama <input type="text" size="5" value="{prm_stat_thnkerja}" name="stat_thnkerja" style="border: 0px;border-bottom: dotted;text-align: center;"/> tahun.
