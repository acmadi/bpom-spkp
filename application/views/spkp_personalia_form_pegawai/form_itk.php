                ...
                <tr>
                    <td colspan="3">
                        ...
                        if($status_kirim=="1"){
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permohonan izin tidak masuk kerja selama ({prm_jml}) hari kerja
                                pada tanggal {prm_stat_tgl} dengan alasan ada keperluan keluarga di luar kota.
                            </p>
                            <?php
                        }else{
                            ?>
                            <p align='justify'>
                                Dengan ini mengajukan permohonan izin tidak masuk kerja selama <input type="text" size="8" value="{prm_jml}" name="jml" style="border: 0px;border-bottom: dotted;text-align: center;"/> hari kerja
                                pada tanggal <div id="stat_tgl"></div> dengan alasan ada keperluan keluarga di luar kota.
                            </p>
                            <?php
                        }
                        ?>
