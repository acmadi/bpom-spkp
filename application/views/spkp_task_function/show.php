<script>
	$(function(){
       ...
       $("#tugas_fungsi_dit_spkp").addClass("active");
	   ...
	   var source = {
		...
		url: "<?php echo base_url(); ?>spkp_task_function/json_tugasfungsi",
		cache: false,
	   ...
	   $('#btn_tambah').click(function(){
			...
			$.get("<?php echo base_url();?>spkp_task_function/add" , function(response) {
		...
		$('#printbutton').click(function () {
			...
			$.ajax({ 
				...
				url: "<?php echo base_url();?>spkp_task_function/html",
		...
		$('#excelbutton').click(function () {
			...
			$.ajax({ 
				type: "POST",
				data: datastring+'&filterscount='+k,
				url: "<?php echo base_url();?>spkp_task_function/excel",
				success: function(response){
	...
	function edit(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_task_function/edit/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
	...
	function download(id){
		...
		$("#popup").jqxWindow('open');
		$.get("<?php echo base_url();?>spkp_task_function/download/"+id , function(response) {
			$("#popup_content").html("<div>"+response+"</div>");
		});
	}
...
<div class="row-fluid">
   <div class="span12">
	   <h3 class="page-title">
		 Tugas Pokok dan Fungsi DIT SPKP
	   </h3>
   </div>
</div>
<div id="popup" style="display:none"><div id="popup_title">Tugas Pokok dan Fungsi DIT SPKP</div><div id="popup_content">{popup}</div></div>
<div>
