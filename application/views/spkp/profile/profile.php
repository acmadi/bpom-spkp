<script type="text/javascript">
    ...
    function save_profile(){
        ...
        $.ajax({
		   ...
		   contentType: false,
		   processData: false,
           url: "<?php echo base_url(); ?>spkp/doedit_profile",
           data: data,
           success: function(response){
                if(response=="1"){
                  // $("#msg").css("display","block");
                  // $("#msg").html("Successfully save data !");
                   
                   $('#filename').val("");
                   /*
                   var settime = 2;
                   $("#show-time").html(settime);
                   ...
                   */
                   ...
                   $.ajax({
                     type: "POST",
                     url: "<?php echo base_url(); ?>spkp/load_form_profile",
                     success: function(response){
                        $("#divFormProfile").show();
...
<div id="divFormProfile">
	...
	<div style="position:relative;float:right;right:200px;border:15px solid #EFEFEF;top:50px">
		<img src="<?php echo base_url()?>spkp/get_image_profile_big/{id}/<?php echo time()?>" style="border:8px solid #EFEFEF" onclick="upload_image()">
	</div>
    <h3 class="page-title" style="width:60%;position:relative;float:left;">
		Biodata
    </h3>
    <table border='0' width='60%' cellpadding='3' cellspacing='2' style="font-size: 12px;color: black;position:relative;float:left">
        ...
        <tr>
         ...
         <tr>
           ...
           <td align='middle'>:</td>
           <td>
              <select size="1" class="input" name="kawin" id="kawin" style="width: 110px;margin: 0;">
              <?php
